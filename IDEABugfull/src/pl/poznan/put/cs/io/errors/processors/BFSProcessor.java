...
/**
 * Jan Cieśla
 *  Class BFS processor implements BFS algorithm and helper methods
 */
public class BFSProcessor {
     ...
     * Jan Cieśla
     * bug found
     * invalid condition of adding node to neighbors, negation of visitedNodes.contains(i) is valid
